...
#define SPI1_Reset() RCC->APBRSTR2 = RCC_APBRSTR2_SPI1RST; RCC->APBRSTR2 = 0
#define SPI2_Reset() RCC->APBRSTR1 = RCC_APBRSTR1_SPI2RST; RCC->APBRSTR1 = 0
#define SPI_Enable(instance) instance->CR1 |= SPI_CR1_SPE
#define SPI_Disable(instance) instance->CR1 &= ~SPI_CR1_SPE
