...
#define INA226_VSHCT_140 0
#define INA226_VSHCT_204 (1 << 3)
#define INA226_VSHCT_332 (2 << 3)
#define INA226_VSHCT_588 (3 << 3)
#define INA226_VSHCT_1100 (4 << 3)
#define INA226_VSHCT_2216 (5 << 3)
#define INA226_VSHCT_4156 (6 << 3)
#define INA226_VSHCT_8244 (7 << 3)

#define INA226_VBUSCT_140 0
#define INA226_VBUSCT_204 (1 << 6)
#define INA226_VBUSCT_332 (2 << 6)
#define INA226_VBUSCT_588 (3 << 6)
#define INA226_VBUSCT_1100 (4 << 6)
#define INA226_VBUSCT_2216 (5 << 6)
#define INA226_VBUSCT_4156 (6 << 6)
#define INA226_VBUSCT_8244 (7 << 6)
...
#define INA226_REG_CONFIG 0
#define INA226_REG_VSHUNT 1
#define INA226_REG_VBUS   2
