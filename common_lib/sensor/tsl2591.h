...
typedef struct
{
  ...
  unsigned short als_low_threshold;
  unsigned short als_high_threshold;
  unsigned short no_persist_als_low_threshold;
  unsigned short no_persist_als_high_threshold;
