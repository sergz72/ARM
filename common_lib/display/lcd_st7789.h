...
#define ST7789_FLAG_DC 0x100
#define ST7789_FLAG_CS 0x200
...
void ST7789_WriteBytes(unsigned int flags, unsigned char *data, unsigned int size); // should be defined in hal.c
void ST7789_WriteColor(unsigned int color, unsigned int count); // should be defined in hal.c
