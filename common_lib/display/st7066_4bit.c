...
static void st7066_write4(unsigned int rs, unsigned int data)
{
	if (rs)
		ST7066_RS_SET;
	else
...
{
  st7066_write4(rs, data >> 4U);
  st7066_write4(rs, data & 0xFU);
}

void st7066_dl8_set(void)
{
  st7066_write4(0, 3U);
}

void st7066_dl4_set(void)
{
  st7066_write4(0, 2U);
}
