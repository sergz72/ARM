...
#define LED_BATTERY_PIN 6
#define LED_BATTERY_ON PORT_REGS->GROUP[0].PORT_OUTCLR = 1 << LED_BATTERY_PIN
#define LED_BATTERY_OFF PORT_REGS->GROUP[0].PORT_OUTSET = 1 << LED_BATTERY_PIN
