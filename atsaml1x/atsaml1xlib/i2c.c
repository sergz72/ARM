...
void i2c_master_init(void)
{
  ...
  NVIC_SetPriority(I2C_MASTER_MB_IRQn, I2C_MASTER_INTERRUPT_PRIORITY);
  NVIC_SetPriority(I2C_MASTER_SB_IRQn, I2C_MASTER_INTERRUPT_PRIORITY);
  NVIC_SetPriority(I2C_MASTER_ERROR_IRQn, I2C_MASTER_INTERRUPT_PRIORITY);
