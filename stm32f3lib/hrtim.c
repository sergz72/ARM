...
void HRTIM_DLLCalibrationStart(HRTIM_TypeDef * HRTIMx, uint32_t CalibrationRate)
{
  ...
  HRTIM_dllcr = (HRTIMx->sCommonRegs).DLLCR;
  ...
  HRTIMx->sCommonRegs.DLLCR = HRTIM_dllcr;
                                         ...
                                         uint32_t OCChannel)
{
  /* Enable the timer output */
   (HRTIMx->sCommonRegs).OENR |= OCChannel;
                                        ...
                                        uint32_t OCChannel)
{
  ...
  HRTIMx->sCommonRegs.ODISR |= OCChannel;
...
{
  /* Enable the timer output */
  HRTIMx->sCommonRegs.OENR |= PWMChannel;
...
{
  /* Disable the timer output */
  HRTIMx->sCommonRegs.ODISR |= PWMChannel;
                                             ...
                                             uint32_t CaptureChannel)
{
  ...
  switch (CaptureChannel)
  {
    ...
    {
      HRTIMx->sTimerxRegs[TimerIdx].CPT1xCR = HRTIM_CAPTURETRIGGER_NONE;
    }
    break;
    case HRTIM_CAPTUREUNIT_2:
    {
      HRTIMx->sTimerxRegs[TimerIdx].CPT2xCR = HRTIM_CAPTURETRIGGER_NONE;
    }
    break;
    default:
    break;  
  ...
  /* Disable the timer counter */
  if ((HRTIMx->sTimerxRegs[TimerIdx].CPT1xCR == HRTIM_CAPTURETRIGGER_NONE) &&
      (HRTIMx->sTimerxRegs[TimerIdx].CPT2xCR == HRTIM_CAPTURETRIGGER_NONE))
  {
    __HRTIM_DISABLE(HRTIMx, TimerIdxToTimerId[TimerIdx]);
  }
...
{
  /* Enable the timer output */
  HRTIMx->sCommonRegs.OENR |= OnePulseChannel;
...
{
  /* Disable the timer output */
  HRTIMx->sCommonRegs.ODISR |= OnePulseChannel;
...
{ 
   ...
   HRTIMx->sMasterRegs.MCR |= TimersToStart;
}
                                                ...
                                                uint32_t TimersToStop)
{
  ...
  HRTIMx->sMasterRegs.MCR &= ~TimersToStop;
}
                                                ...
                                                uint32_t OutputsToStart)
{
  ...
  HRTIMx->sCommonRegs.OENR = OutputsToStart;
}
                                               ...
                                               uint32_t OutputsToStop)
{
  ...
  HRTIMx->sCommonRegs.ODISR = OutputsToStop;
}
...
void HRTIM_ITConfig(HRTIM_TypeDef * HRTIMx, uint32_t TimerIdx, uint32_t HRTIM_IT, FunctionalState NewState)
{
  switch(TimerIdx)
  {
    case HRTIM_TIMERINDEX_MASTER:
    {
      if(NewState != DISABLE)
      {
        HRTIMx->sMasterRegs.MDIER |= HRTIM_IT;
      }
      else
      {
        HRTIMx->sMasterRegs.MDIER &= ~HRTIM_IT;
    ...
    case HRTIM_TIMERINDEX_TIMER_E:
    {
      if(NewState != DISABLE)
      {
        HRTIMx->sTimerxRegs[TimerIdx].TIMxDIER |= HRTIM_IT;
      }
      else
      {
        HRTIMx->sTimerxRegs[TimerIdx].TIMxDIER &= ~HRTIM_IT;
...
void HRTIM_ITCommonConfig(HRTIM_TypeDef * HRTIMx, uint32_t HRTIM_CommonIT, FunctionalState NewState)
{
   if(NewState != DISABLE)
    {
      HRTIMx->sCommonRegs.IER |= HRTIM_CommonIT;
    }
    else
    {
      HRTIMx->sCommonRegs.IER &= ~HRTIM_CommonIT;
...
void HRTIM_ClearFlag(HRTIM_TypeDef * HRTIMx, uint32_t TimerIdx, uint32_t HRTIM_FLAG)
{
  switch(TimerIdx)
  {
    case HRTIM_TIMERINDEX_MASTER:
    {
      HRTIMx->sMasterRegs.MICR |= HRTIM_FLAG;
    }
    break;
    case HRTIM_TIMERINDEX_TIMER_A:
    case HRTIM_TIMERINDEX_TIMER_B:
    ...
    case HRTIM_TIMERINDEX_TIMER_E:
    {
      HRTIMx->sTimerxRegs[TimerIdx].TIMxICR |= HRTIM_FLAG;
    }
    break;
...
{
  HRTIMx->sCommonRegs.ICR |= HRTIM_CommonFLAG;
}
...
void HRTIM_ClearITPendingBit(HRTIM_TypeDef * HRTIMx, uint32_t TimerIdx, uint32_t HRTIM_IT)
{
  switch(TimerIdx)
  {
    case HRTIM_TIMERINDEX_MASTER:
    {
      HRTIMx->sMasterRegs.MICR |= HRTIM_IT;
    }
    break;
    case HRTIM_TIMERINDEX_TIMER_A:
    case HRTIM_TIMERINDEX_TIMER_B:
    ...
    case HRTIM_TIMERINDEX_TIMER_E:
    {
      HRTIMx->sTimerxRegs[TimerIdx].TIMxICR |= HRTIM_IT;
    }
    break;
...
{
  HRTIMx->sCommonRegs.ICR |= HRTIM_CommonIT;
}
...
FlagStatus HRTIM_GetFlagStatus(HRTIM_TypeDef * HRTIMx, uint32_t TimerIdx, uint32_t HRTIM_FLAG)
{
  ...
  switch(TimerIdx)
  {
    case HRTIM_TIMERINDEX_MASTER:
    {
      if ((HRTIMx->sMasterRegs.MISR & HRTIM_FLAG) != RESET)
      {
        bitstatus = SET;
      }
      else
    ...
    case HRTIM_TIMERINDEX_TIMER_E:
    {
      if ((HRTIMx->sTimerxRegs[TimerIdx].TIMxISR & HRTIM_FLAG) != RESET)
      {
        bitstatus = SET;
      }
      else
...
FlagStatus HRTIM_GetCommonFlagStatus(HRTIM_TypeDef * HRTIMx, uint32_t HRTIM_CommonFLAG)
{
  ...
  if((HRTIMx->sCommonRegs.ISR & HRTIM_CommonFLAG) != RESET)
    {
      bitstatus = SET;
    }
    else
...
ITStatus HRTIM_GetITStatus(HRTIM_TypeDef * HRTIMx, uint32_t TimerIdx, uint32_t HRTIM_IT)
{
  ...
  switch(TimerIdx)
  {
    case HRTIM_TIMERINDEX_MASTER:
    {
      itstatus = HRTIMx->sMasterRegs.MISR & HRTIM_IT;
  
      itenable = HRTIMx->sMasterRegs.MDIER & HRTIM_IT;
    ...
    case HRTIM_TIMERINDEX_TIMER_E:
    {
      itstatus = HRTIMx->sTimerxRegs[TimerIdx].TIMxISR & HRTIM_IT;
  
      itenable = HRTIMx->sTimerxRegs[TimerIdx].TIMxDIER & HRTIM_IT;
      if ((itstatus != (uint16_t)RESET) && (itenable != (uint16_t)RESET))
      {
        bitstatus = SET;
      }
...
ITStatus HRTIM_GetCommonITStatus(HRTIM_TypeDef * HRTIMx, uint32_t HRTIM_CommonIT)
{
  ...
  itstatus = HRTIMx->sCommonRegs.ISR & HRTIM_CommonIT; 
  itenable = HRTIMx->sCommonRegs.IER & HRTIM_CommonIT;
...
void HRTIM_DMACmd(HRTIM_TypeDef* HRTIMx, uint32_t TimerIdx, uint32_t HRTIM_DMA, FunctionalState NewState)
{
  switch(TimerIdx)
  {
    case HRTIM_TIMERINDEX_MASTER:
    {
      if(NewState != DISABLE)
      {
        HRTIMx->sMasterRegs.MDIER |= HRTIM_DMA;
      }
      else
      {
        HRTIMx->sMasterRegs.MDIER &= ~HRTIM_DMA;
    ...
    case HRTIM_TIMERINDEX_TIMER_E:
    {
      if(NewState != DISABLE)
      {
        HRTIMx->sTimerxRegs[TimerIdx].TIMxDIER |= HRTIM_DMA;
      }
      else
      {
        HRTIMx->sTimerxRegs[TimerIdx].TIMxDIER &= ~HRTIM_DMA;
                                           ...
                                           uint32_t RegistersToUpdate)
{
  ...
  switch (TimerIdx) 
  {
    case HRTIM_TIMERINDEX_TIMER_A:
    {
      HRTIMx->sCommonRegs.BDTAUPR = RegistersToUpdate;
    }
    break;
    case HRTIM_TIMERINDEX_TIMER_B:
    {
      HRTIMx->sCommonRegs.BDTBUPR = RegistersToUpdate;
    }
    break;
    case HRTIM_TIMERINDEX_TIMER_C:
    {
      HRTIMx->sCommonRegs.BDTCUPR = RegistersToUpdate;
    }
    break;
    case HRTIM_TIMERINDEX_TIMER_D:
    {
      HRTIMx->sCommonRegs.BDTDUPR = RegistersToUpdate;
    }
    break;
    case HRTIM_TIMERINDEX_TIMER_E:
    {
      HRTIMx->sCommonRegs.BDTEUPR = RegistersToUpdate;
    }
    break;
    case HRTIM_TIMERINDEX_MASTER:
    {
      HRTIMx->sCommonRegs.BDMUPR = RegistersToUpdate;
    }
    break;
    default:
    break;
                                            ...
                                            uint32_t CaptureUnit)
{
  ...
  switch (CaptureUnit)
  {
    case HRTIM_CAPTUREUNIT_1:
    {
      HRTIMx->sTimerxRegs[TimerIdx].CPT1xCR |= HRTIM_CPT1CR_SWCPT;
    }
    break;
    case HRTIM_CAPTUREUNIT_2:
    {
      HRTIMx->sTimerxRegs[TimerIdx].CPT2xCR |= HRTIM_CPT2CR_SWCPT;
    }
    break;
    default:
    break;
                                           ...
                                           uint32_t TimersToUpdate)
{
  ...
  HRTIMx->sCommonRegs.CR2 |= TimersToUpdate;
...
{
  /* Force timer(s) registers update */
  HRTIMx->sCommonRegs.CR2 |= TimersToReset;
}
  ...
  switch (Output)
  {
    ...
    case HRTIM_OUTPUT_TE1:
    {
      if (OutputLevel == HRTIM_OUTPUTLEVEL_ACTIVE)
      {
        ...
        HRTIMx->sTimerxRegs[TimerIdx].SETx1R |= HRTIM_SET1R_SST;
      }
      else
      {
        /* Force output to its inactive state */
        HRTIMx->sTimerxRegs[TimerIdx].RSTx1R |= HRTIM_RST1R_SRT;
      }
    }
    break;
    case HRTIM_OUTPUT_TA2:
    ...
    case HRTIM_OUTPUT_TE2:
    {
      ...
      {
        /* Force output to its active state */
        HRTIMx->sTimerxRegs[TimerIdx].SETx2R |= HRTIM_SET2R_SST;
      }
      else
      {
        /* Force output to its inactive state */
        HRTIMx->sTimerxRegs[TimerIdx].RSTx2R |= HRTIM_RST2R_SRT;
      }
    }
    break;
    default:
                                    ...
                                    uint32_t CaptureUnit)
{
  ...
  switch (CaptureUnit)
  {
    case HRTIM_CAPTUREUNIT_1:
    {
      captured_value = HRTIMx->sTimerxRegs[TimerIdx].CPT1xR;
    }
    break;
    case HRTIM_CAPTUREUNIT_2:
    {
      captured_value = HRTIMx->sTimerxRegs[TimerIdx].CPT2xR;
    }
    break;
    default:
    break;
                                          ...
                                          uint32_t Output)
{
  ...
  switch (Output)
  {
    ...
    case HRTIM_OUTPUT_TE1:
    {
      if ((HRTIMx->sTimerxRegs[TimerIdx].TIMxISR & HRTIM_TIMISR_O1CPY) != RESET)
      {
    ...
    case HRTIM_OUTPUT_TE2:
    {
      if ((HRTIMx->sTimerxRegs[TimerIdx].TIMxISR & HRTIM_TIMISR_O2CPY) != RESET)
      {
        output_level = HRTIM_OUTPUTLEVEL_ACTIVE;
      }
      else
                                          ...
                                          uint32_t Output)
{
  ...
  if ((HRTIMx->sCommonRegs.OENR & output_bit) != RESET)
  {
  ...
  {
    if ((HRTIMx->sCommonRegs.ODSR & output_bit) != RESET)
    {
                                              ...
                                              uint32_t Output)
{
  ...
  switch (Output)
  {
    ...
    case HRTIM_OUTPUT_TE1:
    {
      if ((HRTIMx->sTimerxRegs[TimerIdx].TIMxISR & HRTIM_TIMISR_O1STAT) != RESET)
      {
    ...
    case HRTIM_OUTPUT_TE2:
    {
      if ((HRTIMx->sTimerxRegs[TimerIdx].TIMxISR & HRTIM_TIMISR_O2STAT) != RESET)
      {
...
uint32_t HRTIM_GetBurstStatus(HRTIM_TypeDef * HRTIMx)
{
  ...
  burst_mode_status = (HRTIMx->sCommonRegs.BMCR & HRTIM_BMCR_BMSTAT);
                                            ...
                                            uint32_t TimerIdx)
{
  ...
  current_pushpull_status = (HRTIMx->sTimerxRegs[TimerIdx].TIMxISR & HRTIM_TIMISR_CPPSTAT);
                                         ...
                                         uint32_t TimerIdx)
{
  ...
  /* Read current push pull status */
  idle_pushpull_status = (HRTIMx->sTimerxRegs[TimerIdx].TIMxISR & HRTIM_TIMISR_IPPSTAT);
                           ...
                           uint32_t Event)
{
  switch (Event)
  {
    case HRTIM_EVENT_1:
    {
      HRTIMx->sTimerxRegs[TimerIdx].RSTxR = HRTIM_TIMRESETTRIGGER_EEV_1;
    }
    break;
    case HRTIM_EVENT_2:
    {
      HRTIMx->sTimerxRegs[TimerIdx].RSTxR = HRTIM_TIMRESETTRIGGER_EEV_2;
    }
    break;
    case HRTIM_EVENT_3:
    {
      HRTIMx->sTimerxRegs[TimerIdx].RSTxR = HRTIM_TIMRESETTRIGGER_EEV_3;
    }
    break;
    case HRTIM_EVENT_4:
    {
      HRTIMx->sTimerxRegs[TimerIdx].RSTxR = HRTIM_TIMRESETTRIGGER_EEV_4;
    }
    break;
    case HRTIM_EVENT_5:
    {
      HRTIMx->sTimerxRegs[TimerIdx].RSTxR = HRTIM_TIMRESETTRIGGER_EEV_5;
    }
    break;
    case HRTIM_EVENT_6:
    {
      HRTIMx->sTimerxRegs[TimerIdx].RSTxR = HRTIM_TIMRESETTRIGGER_EEV_6;
    }
    break;
    case HRTIM_EVENT_7:
    {
      HRTIMx->sTimerxRegs[TimerIdx].RSTxR = HRTIM_TIMRESETTRIGGER_EEV_7;
    }
    break;
    case HRTIM_EVENT_8:
    {
      HRTIMx->sTimerxRegs[TimerIdx].RSTxR = HRTIM_TIMRESETTRIGGER_EEV_8;
    }
    break;
    case HRTIM_EVENT_9:
    {
      HRTIMx->sTimerxRegs[TimerIdx].RSTxR = HRTIM_TIMRESETTRIGGER_EEV_9;
    }
    break;
    case HRTIM_EVENT_10:
    {
      HRTIMx->sTimerxRegs[TimerIdx].RSTxR = HRTIM_TIMRESETTRIGGER_EEV_10;
    }
    break;
    default:
    break;
