...
void I2C_Init(I2C_TypeDef *instance, I2C_InitTypeDef *init)
{
  ...
  unsigned int freqrange = I2C_FREQRANGE(BOARD_PCLK1);
  ...
  MODIFY_REG(instance->CCR, (I2C_CCR_FS | I2C_CCR_DUTY | I2C_CCR_CCR), I2C_SPEED(BOARD_PCLK1, init->ClockSpeed, init->DutyCycle));
